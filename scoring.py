...
LABELS = {
    "likely_ai": "Our automated system found strong signs that this content may have been AI-generated.",
    "likely_human": "Our automated system found strong signs that this content was likely written by a person.",
...
def label_for_attribution(attribution):
    """Return the transparency label text shown to readers for a given attribution result."""
